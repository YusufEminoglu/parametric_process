...
class UrbanPhysicsEvaluatorAlgorithm(QgsProcessingAlgorithm):
    ...
    def shortHelpString(self):
        return (
            ...
            "criteria (Lawson & Penwarden, 1975 — Proceedings of the 4th International Conference on Wind Effects on Buildings and Structures): "
...
class ProceduralShapeGrammarAlgorithm(QgsProcessingAlgorithm):
    ...
    def shortHelpString(self):
        return (
            ...
            "rules operating on labelled geometries. Parish & Müller (2001 — Proc."
            ...
            "Urbanism: Towards Time-consciousness in Place-making', in Mäckler & Sonne "
            "(eds.), Dortmunder Vorträge zur Stadtbaukunst: New Civic Art, pp. 82–111, "
            "Niggli; Tarbatt, 2012 — 'The Plot: Designing "
...
class PpudPipelineAlgorithm(QgsProcessingAlgorithm):
    ...
    def shortHelpString(self):
        return (
            ...
            "Planning Context', supervised by Assoc. Prof. Dr. Olgu Çalışkan) and "
            "extended with climate-responsive multi-objective optimisation in Akay & "
            "Çalışkan (2025 — Urban Design International, advance online, 'A Parametric Approach "
